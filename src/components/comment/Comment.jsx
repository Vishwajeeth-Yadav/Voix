...
function Comment({ addComment, commentText, setcommentText, allComments, fullName, setFullName }) {
  ...
  return (
    <section className="py-8 lg:py-16">
      <div className="max-w-2xl mx-auto px-4">
        ...
        {/* Comment Form  */}
        <form className="mb-6" onSubmit={handleSubmit}>  {/* Added onSubmit to handle form submission */}
          {/* Full Name Input  */}
          <div className="py-2 px-4 mb-4 rounded-lg rounded-t-lg shadow-[inset_0_0_4px_rgba(0,0,0,0.6)] border border-gray-200"
            ...
            <input
              ...
              className="px-0 w-full text-sm border-0 focus:ring-0 focus:outline-none placeholder:text-gray-600 dark:text-white dark:placeholder-gray-400"
              style={{
                background: mode === 'dark' ? '#353b48' : 'rgb(226, 232, 240)'
              }}
            />
